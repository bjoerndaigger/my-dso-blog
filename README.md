...
The website is automatically deployed to GitHub Pages via a prepared GitHub Actions workflow. Every commit pushed to the main branch triggers a new deployment.
