...
const gitRepositoryUrl =
  process.env.GIT_REPOSITORY_URL ?? 'https://github.com/bjoerndaigger/my-dso-blog';
...
const config: Config = {
  ...
  url: process.env.DEPLOYMENT_URL ?? "https://bjoerndaigger.github.io",
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Björn Daigger. Built with Docusaurus and 💚. Extended from the developer-akademie-starter.`,
    },
    prism: {
